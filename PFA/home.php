...
<body>
  <header>
    <!-- <a href="snippets/forgot_password.html">dsqfsdf</a> -->
    <div id="header-nav" >
      <div id="header-container" class="container">
        <div id="navbar-header" class="navbar-header">
          <a href="#home" onclick="$dc.loadhome();" class="pull-left visible-md visible-lg">
            <div id="logo-img" alt="Logo image">
            </div>
          </a>
          <div id = "navbar-brand" class="navbar-brand">
            <a href="#home" onclick="$dc.loadhome();"><h1>ENSIAS</h1></a>
            <p>
